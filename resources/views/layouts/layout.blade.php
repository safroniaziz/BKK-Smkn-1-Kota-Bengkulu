...
<html lang="en">
  <head>
    ...
    <title>BKK SMkN 1 Bengkulu | @yield('title') </title>
      ...
      <div class="main_container" style="background:#013C62;">
        ...
        <div class="left_col scroll-view" style="background: #013C62 !important;">
            <div class="navbar nav_title" style="border-bottom: 1px white solid;; margin:0; padding-bottom:5px 0px !important; background:#013C62;">
                <a href="index.html" class="site_title" style="font-weight:600; font-size:13px !important;"><i class="fa fa-home"></i> <span>BKK SMKN 1 Kota Bengkulu</span></a>
              </div>
            ...
            <div class="profile clearfix">
                <div class="profile_pic">
                  <img src="{{ asset('assets/images/logo.jpg') }}"style="width:70%; background:#fff; margin-left:15%;z-index:1000; position:inherit;margin-top:20px;border: 1px solid rgba(52,73,94,0.44);padding: 4px;border-radius:50%;filter:drop-shadow(0px 1px 5px #fff);" alt="..." class="img-circle profile_img">
                </div>
        ...
        <footer style="overflow:hidden;">
          ...
          <div class="pull-right">
             <a>Programmer : Safroni Aziz Suprianto</a>
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
